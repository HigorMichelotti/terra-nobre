...
export class NavContentComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    public nav: NavigationItemService,
    private zone: NgZone,
  ...
  ngOnInit() {
    ...
    this.nomeUsuario = this.authService.obterDadosUsuario().dadosUsuario.nome;
  ...
  // obterMenu() {
  //   const menuNavegacaoLocalStorage = this.localStorageService.get(KeyLocalStorage.MenuNavegacao);

  //   if (menuNavegacaoLocalStorage) {
  //     this.navigation = menuNavegacaoLocalStorage
  //     return;
  //   }

  //   this.nav.obterMenuLateral().subscribe({
  //     next: (dados) => {
  //       this.navigation = [dados]
  //       this.localStorageService.set(KeyLocalStorage.MenuNavegacao, this.navigation)
  //     },
  //     error: (error) => {
  //       EmitirAlerta.AlertaToastError(error)
  //     }
  //   });
  // }
  ...
  fireLeave() {
    ...
    if (this.location.getBaseHref()) {
      current_url = this.location.getBaseHref() + this.location.path();
    }
