...
export class ConfigurationComponent implements OnInit {
  ...
  scroll = (): void => {
    ...
    } else if (document.querySelector(".pcoded-navbar") != null && document.querySelector(".pcoded-navbar").hasAttribute('style')) {
      document.querySelector('.pcoded-navbar.menupos-fixed').removeAttribute('style');
    }
  }

  constructor(private zone: NgZone, private location: LocationStrategy) {
  ...
  changeMenuFixedLayout(flag:any) {
    setTimeout(() => {
      if (flag) {
  ...
  changeHeaderFixedLayout(flag:any) {
    if (flag) {
  ...
  setHeaderBackground(background:any) {
  ...
  setBrandBackground(background:any) {
